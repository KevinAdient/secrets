...
@interface NSBundle (SWIFT_EXTENSION(Siren))
@end
...
*/
SWIFT_CLASS("_TtC5Siren5Siren")
@interface Siren : NSObject
/**
  The error domain for all errors created by Siren
*/
@property (nonatomic, readonly, copy) NSString * _Nonnull SirenErrorDomain;
/**
...
*/
@property (nonatomic, strong) UIColor * _Nullable alertControllerTintColor;
/**
  The current version of your app that is available for download on the App Store
*/
@property (nonatomic, readonly, copy) NSString * _Nullable currentAppStoreVersion;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Siren * _Nonnull sharedInstance;)
+ (Siren * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


@interface Siren (SWIFT_EXTENSION(Siren))
@end
...
@interface UIAlertController (SWIFT_EXTENSION(Siren))
@end
